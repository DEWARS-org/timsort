...
class TimSort<T> {
   ...
   */
  public static readonly DEFAULT_MIN_MERGE = 32;

  /**
   * Minimum ordered subsequece required to do galloping.
   */
  public static readonly DEFAULT_MIN_GALLOPING = 7;

  /**
   * Default tmp storage length. Can increase depending on the size of the smallest run to merge.
   */
  public static readonly DEFAULT_TMP_STORAGE_LENGTH = 256;

  /**
   * Pre-computed powers of 10 for efficient lexicographic comparison of small integers.
   */
  public static readonly POWERS_OF_TEN = [
    1e0,
    1e1,
    1e2,
    1e3,
  ...
  private length = 0;
  private tmpStorageLength = TimSort.DEFAULT_TMP_STORAGE_LENGTH;
   ...
   * @return The estimated logarithm of the integer.
   */
   ...
   */
  public static alphabeticalCompare(
    a: number,
    b: number,
  ): number {
    if (a === b) {
   ...
   */
  public static minRunLength(n: number): number {
    let r = 0;
   ...
   */
  public static makeAscendingRun<T>(
    array: T[],
    lo: number,
    hi: number,
   ...
   * @param hi - Last element in the range.
   */
  public static reverseRun<T>(array: T[], lo: number, hi: number): void {
    hi--;
   ...
   * @param compare - Item comparison function.
   */
  public static binaryInsertionSort<T>(
    array: T[],
    lo: number,
    hi: number,
    start: number,
   ...
   */
  public pushRun(runStart: number, runLength: number) {
...
export const sort = <T = number>(
  array: T[],
  compare: CompareFunction<T> = TimSort.alphabeticalCompare as CompareFunction<
    T
  >,
  lo: number = 0,
